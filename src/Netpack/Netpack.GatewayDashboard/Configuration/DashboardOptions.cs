...
namespace Netpack.GatewayDashboard.Configuration;
...
public sealed class ResourceServiceClientOptions
{
    ...
    {
        return _apiKeyBytes ?? throw new InvalidOperationException($"{nameof(ApiKey)} is not available.");
    }
...
public sealed class OtlpOptions
{
    ...
    public List<AllowedCertificateRule> AllowedCertificates { get; set; } = [];
...
public sealed class FrontendOptions
{
    ...
    public byte[]? GetBrowserTokenBytes()
    {
        return _browserTokenBytes;
    }
